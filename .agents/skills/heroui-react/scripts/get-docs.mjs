 ...
 *
 * Usage:
 *   node get-docs.mjs /docs/react/getting-started/theming
 *   node get-docs.mjs /docs/react/releases/v3-0-0-beta-3
 *
 * Output:
...
async function fetchFallback(path) {
	...
	let cleanPath = path.replace(LEADING_SLASH_RE, "");
...
async function main() {
	...
	if (args.length === 0) {
		...
		console.error(
			"Example: node get-docs.mjs /docs/react/getting-started/theming"
		);
		console.error();
